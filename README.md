...
An experimental AI DJ that controls [Ableton Live](https://www.ableton.com/en/) via OSC. A [DSPy Reactive Language Model (RLM)](https://dspy.ai/api/modules/RLM/) writes Python code that browses sounds, creates tracks, writes MIDI clips, and manages live performance in real time.

Music generated by bergain is available on a Soundcloud playlist [here](https://soundcloud.com/clay-smith-36/sets/github-com-smithclay-bergain).
